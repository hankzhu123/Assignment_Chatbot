#
# training data source: https://www.nltk.org/api/nltk.chat.html
...
pairs1 = [
        ...
        ['(.*)old(.*) ?', ["I don't know, I'm just a computer program..."]],
        ['(cya|See you later|Goodbye|I am Leaving|Have a Good day|quit)',
         ["Sad to see you go :(", "Talk to you later", "Goodbye!"]],
        ['(.*)name(.*) ?',
         ["You can call me Harry, and you? ", "I'm Harry! What about you?", "I'm Harry aka Hank With the Harry, you?"]],
        ['(.*) created you ?', ["Hank did by using NLTK Python"]],
        ['how is the weather in (.*) ?', ["I don't know the weather in %1, you can always ask Google - my bf"]],
        ['(.*)', ["I'dont understand, please tell me more", "I see", "Very Interesting", "I don't know how to response that"]]
]
...
def the_chatbot_harry():
    print("Hello, my name is Harry, you can ask all kind of things (Not quite)... \n"
          "You can ask me age, the weather, my creator... that's it...  I'm pretty simple machine.\n"
          "\n What's your name?")
    chat = Chat(pairs1, reflections)
    chat.converse()

def the_chatbot_eliza():
    print("Hello, my name is Eliza, I was written by NLTK.org  \n"
          "You can ask me a lots of thing.\n"
          "\n How are you feeling today")
    chat = Chat(pairs2, reflections)
    chat.converse()

def the_chatbot_iesha():
    print("Hello, my name is iesha, I was written by NLTK.org  \n"
          "  ;)\n"
          "\n Who r u??!")
...
def user_menu():
    ai = input("Please select what do you want to talk to? \n"
               "1. Harry the Hank \n"
               "2. Eliza \n"
               "3. Iesha ;) \n")
    if ai == '1':
